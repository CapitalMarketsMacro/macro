...
apps/
  ...
  market-data-server/   # Node.js WebSocket server (port 3000) — mock FX + Treasury data
  capital-markets-themes/ # React Figma-themes showcase
...
| macro-angular-fdc3 | 4203 |
| market-data-server | 3000 |

New LOB apps use ports 4204+.
