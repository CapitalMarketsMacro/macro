...
`);
    ...
    // NOTE: OpenFin dock3 favorites require icon to be a plain string URL.
    // The { dark, light } object format causes dock registration to hang and
    // blocks Home/Store/Dock from loading. Use the dark variant (default theme).
